...
HD_PWD='C:/Users/This PC/vivado_projects/Lab9/Lab9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Processor_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Processor_4bit.tcl
