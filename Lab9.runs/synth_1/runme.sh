...
HD_PWD='C:/Users/ASUS/nanoprocessor_4bit/Lab9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Add_3bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Add_3bit.tcl
