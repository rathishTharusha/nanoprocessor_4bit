...
HD_PWD='C:/Users/This PC/vivado_projects/Lab9/Lab9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Processor_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Processor_4bit.tcl -notrace
