...
## Switches
set_property PACKAGE_PIN V17 [get_ports {RegSel[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {RegSel[0]}]
set_property PACKAGE_PIN V16 [get_ports {RegSel[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {RegSel[1]}]
set_property PACKAGE_PIN W16 [get_ports {RegSel[2]}]
...
#set_property PACKAGE_PIN U3 [get_ports {Flags[11]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {Flags[11]}]
